...
public class ErrorConstants {
    ...
    public static final String NO_CAMPAIGN_FOR_PARTNER = "No active Campaign found for the partner";
    public static final String NO_CAMPAIGN_FOUND = "Campaign not found to update";
    public static final String NO_CAMPAIGN_FOUND_TO_DELETE = "Campaign not found to delete";
